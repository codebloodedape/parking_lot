...
public class ConsoleInterface {
  ...
  /**
   * Main method of the entry Class ConsoleInterface. This method will take the first argument, if provided,
   * for the path of the command file, else, read commands from the console
   * 
   * @param args
   *          array of arguments. The command file path should be the first argument in the array.
   */
    ...
    if (args.length == 0) {
      ...
      try {
        ...
        System.out.println("The file " + commandFilePath + " could not be founud. "
            + "Check if the command file exists in the specified location before " + "restarting this application.");
      }
    }
  }
